...
<div class="container">
    ...
    <p> Grouped centrality metrics for WT_5u6o (top), WT_6uqf (middle) and WT_6uqg (bottom). Metrics were grouped based on apparent similarity as seen in plots such as Figure 8. Metric values were normalized in the range $[0, 1]$. Black circles indicate values in the 90th percentile. </p>
    </figure>
</div>
...
<figure class="inline-block">
  ...
  <p> Close-up view of the C-terminal S4 (right), S5, and S6 (left) for 'WT_5u6o.' The bottom of the image corresponds to the cytosolic direction. F431 and its first neighbours are shown as sticks. Residues (of the full protein) are coloured according to their betweenness centrality, where higher values are indicated by brighter colours. Note how the majority of the protein is uniformly dark, besides residues near F431. </p>
</figure>
