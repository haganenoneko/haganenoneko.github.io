...
Radius of gyration is a familiar concept to physicists, but perhaps not for most (traditional) biologists. Wikipedia describes it as follows:

<br>
<blockquote cite="https://en.wikipedia.org/wiki/Radius_of_gyration" style="background-color:#3d3d3d"> the axis of rotation is defined as the radial distance to a point which would have a moment of inertia the same as the body's actual distribution of mass, if the total mass of the body were concentrated there </blockquote>
<br>
...
<figure>
  ...
  <figcaption>
    <b> Fig. 6 - Pore profiles of WT and F431A HCN2 channels. </b>
    <br>
